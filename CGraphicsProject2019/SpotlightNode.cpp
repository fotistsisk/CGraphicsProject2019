...
SpotLightNode::SpotLightNode()
{
	...
	m_cast_shadow = false;
	m_shadow_map_resolution = 1024; //4K framebuffer-->4096
...
void SpotLightNode::SetPosition(glm::vec3 pos)
{
	...
	m_view_inverse_matrix = glm::inverse(m_view_matrix); // prepei na gurisw apo to xwro tou fwtos
}
